...
from AloneX.utils.inline.play import (livestream_markup,
                                          playlist_markup,
...
@app.on_callback_query(
    filters.regex("AloneymousAdmin") & ~BANNED_USERS
)
async def Aloneymous_check(client, CallbackQuery):
    try:
        await CallbackQuery.answer(
...
@app.on_callback_query(
    filters.regex("AlonePlaylists") & ~BANNED_USERS
)
@languageCB
